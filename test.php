...
include 'connection.php';
  if (isset($_GET['lab'])) {
    $lab_name=$_GET['lab'];
    $q = "SELECT * FROM test_master t JOIN lab_master l ON t.lab_id=l.lab_id JOIN user_master u ON l.u_id=u.u_id WHERE u_name = '$lab_name'";
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span><span><a href="lab-single.php?lab=<?php echo $lab_name; ?>"><?php echo $lab_name; ?> <i class="ion-ios-arrow-forward"></i></a></span></p>
            <h1 class="mb-3 bread" style="color: white;">List Of Available Tests</h1>
          </div>
        </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="property-wrap ftco-animate">
              ...
              <div class="text">
                <h2><a href="test-single.php?test=<?php echo $row['t_name'];?>"><?php echo $row['t_name'];?></a></h2>
                <h6><?php echo $row['u_name'];?></h6>
                <a href="test-single.php?test=<?php echo $row['t_name'];?>" class="d-flex align-items-center justify-content-center btn-custom">
