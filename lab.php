...
include 'connection.php';
    $q = "SELECT u.u_id,u.u_img,u.u_name,u.u_addr,u.u_phn,u.u_email,l.lab_id,l.l_mor_time,l.l_noon_time,l.home_service FROM lab_master l JOIN user_master u ON l.u_id=u.u_id JOIN user_type_master ut ON u.u_type_id=ut.u_type_id WHERE u.u_type_id=4";
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            ...
            <h1 class="mb-3 bread" style="color: white;">Labs</h1>
          </div>
        </div>
        </div>
      </div>
