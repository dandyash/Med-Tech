...
if (isset($_GET['l_name'])) {
    $l_name = $_GET['l_name'];
    //$spec = $_GET['spec'];
    $q = "SELECT u.u_id,u.u_img,u.u_name,u.u_addr,u.u_phn,u.u_email,l.lab_id,l.l_mor_time,l.l_noon_time,l.home_service FROM lab_master l JOIN user_master u ON l.u_id=u.u_id JOIN user_type_master ut ON u.u_type_id=ut.u_type_id WHERE u.u_name LIKE '%$l_name%'";
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Labs <i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-3 bread" style="color: white;">Search Results</h1>
          </div>
        </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="property-wrap ftco-animate">
              <a class="img" style="background-image: url(images/lab.jpg);"></a>
              <div class="text">
                <h2><a href="lab-single.php?lab=<?php echo $row['u_name'];?>"><?php echo $row['u_name'];?></a></h2>
                <span class="location"></span>
                <a href="lab-single.php?lab=<?php echo $row['u_name'];?>" class="d-flex align-items-center justify-content-center btn-custom">
