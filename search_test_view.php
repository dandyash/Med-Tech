...
include 'connection.php';
     if (isset($_GET['test_name'])) {
        $test = $_GET['test_name'];
        $q = "SELECT * FROM test_master t JOIN lab_master l ON t.lab_id=l.lab_id JOIN user_master u on l.u_id=u.u_id JOIN user_type_master ut on u.u_type_id=ut.u_type_id WHERE u.u_type_id=4 AND t.t_name LIKE '%$test%'";
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Tests <i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-3 bread" style="color: white;">Tests</h1>
          </div>
        </div>
        </div>
      </div>
