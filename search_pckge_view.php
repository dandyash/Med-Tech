...
include 'connection.php';
     if (isset($_GET['pckge_name'])) {
        $pckge = $_GET['pckge_name'];
        $q = "SELECT * FROM package_maaster p JOIN lab_master l ON p.lab_id=l.lab_id JOIN user_master u on l.u_id=u.u_id JOIN user_type_master ut on u.u_type_id=ut.u_type_id WHERE u.u_type_id=4 AND p.pckge_name LIKE '%$pckge%'";
